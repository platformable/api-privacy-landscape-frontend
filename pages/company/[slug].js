...
console.log("selectedCompany: ",selectedCompany)
  ...
  console.log("numberOfPositionsVacantIn2022",selectedCompany[0].numberOfPositionsVacantInPastYear)
          ...
          <div className="col-md-3 p-y2 bg-white mobile-profile-left border-end-company-color">
           ...
           <div className="company-category mt-2 mb-2">
            ...
            {newParentCategorySlug?.map((category,index)=>{
              ...
              ${subcat==="Privacy Engineering Tools" && "bg-main-color-1-light"}
              ${subcat==="Privacy Engineering Tools" && "bg-main-color-1-light"}

              ${subcat==="Data Vaults & Sharing" && "bg-main-color-2-light"}
              ${subcat==="Identity & Consent Manager" && "bg-main-color-2-light"}
              ${subcat==="Data Subject Access Requests (DSARs)" && "bg-main-color-2-light"}
              ${subcat==="Website and Mobile Tracker Scanning" && "bg-main-color-2-light"}
              ${subcat==="Data Discovery, Classification & Mapping" && "bg-main-color-2-light"}
              ${subcat==="Data Retention and Deletion" && "bg-main-color-2-light"}

              ${subcat==="Privacy Information Maturity" && "bg-main-color-1-light"}
              ${subcat==="Deidentification, Pseudonymization, Anonymization" && "bg-main-color-1-light"}
              ...
              ${subcat==="Centralised Consent Platforms" && "bg-main-color-1-light"}

              ${subcat==="Consumer Facing Data Privacy Solutions" && "bg-main-color-1-light"}
              `}>{subcat}</span>
              })}  
...
export async function getServerSideProps(context) {
  ...
  const res = await fetch(`https://api-privacy-landscape-server-qqk79.ondigitalocean.app/companies` || `http://localhost:5500/companies`);
